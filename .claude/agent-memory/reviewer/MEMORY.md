...
- [GAS Init Possession Timing](feedback_gas_init_possession.md) — PossessedBy/OnRep_Owner 기반 GAS 초기화 패턴, SetOwner 중복 호출 이슈
- [Async Load Refactor Progress](project_async_load_refactor.md) — plan.txt 리팩토링 Phase별 진행상황, 범위 밖 항목/채택된 리스크 목록
